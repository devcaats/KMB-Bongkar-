...
const searchOptions = [
    ...
    { name: "Saas Widgets", path: "/saas", description: "Halaman review komponen SaaS" },
];
        ...
        <header className="sticky top-0 flex w-full bg-white border-gray-200 z-40 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
            <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
                <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
                    <button
                        className="items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border focus:outline-none"
                    ...
                    <Link href="/dashboard" className="lg:hidden flex items-center gap-2">
                        ...
                        />
                        <span className="font-bold text-lg text-gray-900 dark:text-white">KMB Bongkar</span>
                    </Link>

                    <button
                        onClick={toggleApplicationMenu}
                        className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden focus:outline-none"
                    >
                        <svg
                            width="24"
                            height="24"
                    ...
                    <div className="hidden lg:block">
                        <form onSubmit={(e) => e.preventDefault()}>
                            <div className="relative" ref={searchContainerRef}>
                                ...
                                {searchQuery.trim() !== "" && (
                                    <div className="absolute left-0 right-0 top-full mt-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-theme-lg z-50 overflow-hidden max-h-[280px] overflow-y-auto">
                                        {filteredOptions.length === 0 ? (
                                            <div className="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                                                Tidak ada hasil pencarian untuk "{searchQuery}"
                                            </div>
                                        ) : (
                                            <ul className="divide-y divide-gray-150 dark:divide-gray-850">
                                                {filteredOptions.map((opt) => (
                                                    <li key={opt.path}>
                                                        <Link
                                                            href={opt.path}
                                                            onClick={() => setSearchQuery("")}
                                                            className="flex flex-col px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/[0.03] transition-colors"
                                                        >
                                                            <span className="font-semibold text-sm text-gray-850 dark:text-white/90">
                                                                {opt.name}
                                                            </span>
                ...
                <div
                    ...
                    } items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none bg-white dark:bg-gray-900 lg:bg-transparent dark:lg:bg-transparent border-t lg:border-t-0 border-gray-200 dark:border-gray-800`}
                >
